...
let DashboardComponent = class DashboardComponent {
    constructor(_snackBar, _router, _ms) {
        ...
        const routerSub = this._router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])((event) => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationEnd"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(event => {
            // TODO latter
        }))
            .subscribe();
        const msSub = this._ms.message$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(({ message, action }) => {
...
let FrontLogComponent = class FrontLogComponent {
    constructor(_ms) {
        this._ms = _ms;
        this.topics = [
            'ui.jobstate',
    ...
    drawTopicChart(items, topicList = this.topics) {
    ...
    drawTotalChart(items) {
        const totalArray = JSON.parse(items.total);
        const indexes = JSON.parse(items.indexes);
        const startData = [
            ['Time', 'Total']
        ];
        totalArray.forEach((count, index) => {
...
FrontLogComponent.ctorParameters = () => [
...
let LLAComponent = class LLAComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SitesComponent = class SitesComponent {
    constructor() {
